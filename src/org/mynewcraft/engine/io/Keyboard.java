...
public class Keyboard {
    ...
    public Keyboard(Window window) {
        ...
        canClick.put(MOD_SHIFT, false);
        canClick.put(MOD_CONTROL, false);
        canClick.put(MOD_ALT, false);
        canClick.put(MOD_SUPER, false);
        canClick.put(MOD_CAPS_LOCK, false);
        canClick.put(MOD_NUM_LOCK, false);
    }

    public boolean getPress(int key) {
